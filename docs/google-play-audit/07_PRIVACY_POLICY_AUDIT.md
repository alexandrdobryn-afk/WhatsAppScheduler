...
Existing file reviewed and updated: `PRIVACY.md`
...
- Clarified Accessibility usage and consumer WhatsApp-only scope.
- Added user-directed transfer to WhatsApp explanation.
- Added diagnostic report behavior.

Current Privacy Policy coverage:

- Room local storage: covered.
- DataStore preferences: covered.
- Message text: covered.
- Chat/group name: covered.
- Execution history: covered.
- Diagnostic logs/reports: covered.
- Accessibility usage: covered.
- No backend: covered.
- No analytics: covered.
- No ads: covered.
